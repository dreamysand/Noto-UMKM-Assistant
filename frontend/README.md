...
![Transaction](screenshots/light-transaction.png)
![Stock](screenshots/light-stock.png)

### 🌙 Dark Mode
![Dashboard](screenshots/dark-dashboard.png)
![Transaction](screenshots/dark-transaction.png)
![Stock](screenshots/dark-stock.png)
